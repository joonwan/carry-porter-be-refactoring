...
<table>
  ...
  <tr>
    <td colspan="2">
      ...
      <img src="assets/screenshot-network-error.png" alt="로봇 연결 실패 알림 화면" />
    </td>
  </tr>
</table>
...
로컬 실행에 필요한 기본 환경 변수는 `.env.local`에 포함되어 있습니다.

### 1. Frontend 정적 파일 빌드

Nginx 컨테이너는 `frontend/dist`를 정적 파일로 서빙합니다.

따라서 Docker Compose 실행 전에 프론트를 먼저 빌드해야 합니다.
